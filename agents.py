...
class HRAgent(Agent):
    ...
    def Benchmark(self):
        return Agent(
            role="HR Analyst",
            goal="Use the {role} and {inputs} to search the web and find job postings for similar positions and extract requirements",
            backstory="""You are a HR analyst with deep understanding on the {role} position.
    ...
    def Manager(self):
        return Agent(
            ...
            goal="""Define and provide detailed job descriptions, including key responsibilities, qualifications, and required skills
            based on {inputs} for the {role}""",
            backstory="""You are a hiring manager with deep understanding on the {role} position.
    ...
    def Writer(self):
        return Agent(
            ...
            goal="Write a clear and compelling job description for the position: {role}",
            backstory="""You are a HR analyst specialized in writting job descriptions.
              ...
              You ensure the tone reflects the company's culture, and you make sure the description is 
    ...
    def Quality_Assurance(self):
        return Agent(
            ...
            goal="Review the job description for the {role} to ensure high quality results",
            backstory="""You are a senior QA analyst specialized in reviewing job descriptions.
              You're responsible to ensure the job description for the {role} addressed the key requirements listed by the technical
              hiring manager. 
              You ensure the tone reflects the company's culture, and you make sure the description is both detailed 
